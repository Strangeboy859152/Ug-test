...
DATABASE_URL = os.environ.get("DATABASE_URL", "mongodb+srv://krishna931074:4L2TsfrwBSOu3sxB@cluster0.2p4co.mongodb.net/")
MONGO_URL = DATABASE_URL  # For auth system

# Owner and Admin Configuration
OWNER_ID = int(os.environ.get("OWNER_ID", "8167879352"))
ADMINS = [int(x) for x in os.environ.get("ADMINS", "8167879352, 7568561381, 7818565931, 6039166844, 6126688051").split()]  # Default to owner ID
